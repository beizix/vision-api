...
@WebMvcTest(SignupAdminWebAdapter.class)
class SignupAdminWebAdapterTest extends WebMvcTestBase {

  @MockitoBean private SignupUseCase signupUseCase;

  @Test
  @DisplayName("Scenario: 성공 - 관리자 회원가입 요청 시 토큰을 반환한다")
  @WithMockUser
  void signup_admin_success() throws Exception {
    // Given
    SignupAdminReq req = new SignupAdminReq("admin@vision.io", "password", "Admin User");
